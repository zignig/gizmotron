...
class StreamSource:
    @classmethod
    def from_sink(cls, sink): # should be typed to take StreamSink and return StreamSource
...
class SyncFIFOStream(Elaboratable):
    def __init__(self, payload_type: Layout, depth: int, fwft: bool = True, sop: bool = True, eop: bool = True):
