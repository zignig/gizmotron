...
class FIFOUart(Gizmo):
    def build(self, **kwargs):
        ...
        # TX
        tx_status = IO(sig_out=u.TX_FIFO.tx_strobe,sig_in=u.TX_FIFO.tx_rdy,name="tx_status")
        ...
        # RX  
        rx_status = IO(sig_in=u.RX_FIFO.rx_rdy,sig_out=u.RX_FIFO.rx_strobe,name="rx_status")
