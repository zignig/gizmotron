...
class RRR(inst):
    layout = [opcode, rsd, ra, t, rb]


class RR3(inst):
    layout = [opcode, rsd, ra, t, imm3]


class RR5(inst):
    layout = [opcode, rsd, ra, imm5]


class R8(inst):
    layout = [opcode, rsd, imm8]


class C(inst):
    layout = [op4, F, cond, off8]
...
splits = {5: full, 4: modal, 3: extended}
